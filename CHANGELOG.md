...
- Remove native-tls/OpenSSL dependency for better cross-compilation support
- Use rustls-tls exclusively for all TLS operations
- Fix clippy warnings for CI compatibility
...
- **Improved error messages** - Actionable suggestions for common errors:
